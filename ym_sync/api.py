"""Yandex Music download API integration.

Handles fetching download info, downloading encrypted track data,
and decrypting it using AES-CTR.
"""
...
def get_download_info(track: Track, quality: ApiTrackQuality) -> CustomDownloadInfo:
    """Fetch download info for a track at the specified quality level."""
    client = track.client
    assert client
